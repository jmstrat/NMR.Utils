...
insitu_gui <- function() {
  ...
  ui <- shiny::fluidPage(
    shiny::navbarPage('Insitu NMR Processing Wizzard',id = 'tabs',
                       shiny::tabPanel('Import', interactive_import_mod_UI('import')),
                       shiny::tabPanel('Phasing', interactive_phase_mod_UI('phase')),
                       shiny::tabPanel('Baseline', interactive_baseline_mod_UI('baseline')),
                       shiny::tabPanel('Plot', interactive_plotting_mod_UI('plot'))
    )
  )
